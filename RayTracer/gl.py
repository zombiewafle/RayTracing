...
class Raytracer(object):
    ...
    def cast_ray(self, orig, dir, origObj = None, recursion = 0):
        ...
        if material.matType == OPAQUE:
            #finalColor = ml.sumVectors(pLightColor, ambientColor)
            #finalColor = ml.sumVectors(finalColor, dirLightColor)
            ...
            if material.texture and intersect.texCoords:
                #texColor = material.texture.getColor(intersect.texCoords)
                ...
                finalColor = ml.vectorMultiplication(texColor, finalColor)
                finalColor = ml.kMul(finalColor, 0.010)
                #finalColor = ml.norm(finalColor)
